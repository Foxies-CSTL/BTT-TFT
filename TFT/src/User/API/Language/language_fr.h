...
#define _LANGUAGE_FR_H_
    ...
    #define STRING_ROTATED_UI             "Rotation affichage"
    ...
    #define STRING_PROBING_Z_OFFSET       "Ajustement Z_OffSet"
    ...
    #define STRING_PRINT_ACCELERATION     "Accel. Impression"
    #define STRING_RETRACT_ACCELERATION   "Accel. Rétraction"
    #define STRING_TRAVEL_ACCELERATION    "Accel. Déplacements"
    #define STRING_RETRACT_LENGTH         "Longueur Rétract."
    #define STRING_RETRACT_SWAP_LENGTH    "Longueur (multi-extrudeurs)"
    #define STRING_RETRACT_FEEDRATE       "Vitesse Rétract.(mm/min)"
    #define STRING_RETRACT_Z_LIFT         "Décalage en Z"
    #define STRING_RECOVER_LENGTH         "Longueur supplémentaire"
    #define STRING_SWAP_RECOVER_LENGTH    "Longueur reprise(multi-extrudeurs)"
    #define STRING_RECOVER_FEEDRATE       "Vitesse de reprise(mm/min)"
    #define STRING_SWAP_RECOVER_FEEDRATE  "Vitesse de retrait(multi-extrudeurs)"
    ...
    #define STRING_TFT_USB_INSERTED       "Clé USB insérée sur TFT!"
    #define STRING_TFT_USB_REMOVED        "Clé USB retirée du TFT!"
    ...
    #define STRING_SCREEN_SETTINGS        "Prefs Écran"
    #define STRING_UI_SETTINGS            "UI"
    #define STRING_SOUND                  "Son"
    #define STRING_MARLIN_MODE_SETTINGS   "Prefs Marlin"
    #define STRING_MACHINE_SETTINGS       "Prefs Machine"
    ...
    #define STRING_MBL_SETTINGS           "Nivel. Mesh"
    #define STRING_ABL_SETTINGS           "Nivel. Auto"
    #define STRING_ABL_SETTINGS_BBL       "Nivel. Bilinéaire"
    #define STRING_ABL_SETTINGS_UBL       "Nivel. Unifié"
    ...
    #define STRING_TOUCHSCREEN_ADJUST     "Ajuster TFT"
    ...
    #define STRING_UNIFIEDMOVE            "Préparer"
